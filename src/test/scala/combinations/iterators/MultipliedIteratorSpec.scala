...
//      Vector(Vector(0,2),Vector(1),Vector(0,2))  // 31
    ...
    val result3 = MultipliedIterator(Vector(() => Combinations(3,2).iterator(), () => Combinations(2,1).iterator())).toVector
    val expected3 = Vector(
      Vector(Vector(0,1),Vector(0)), // 0
      Vector(Vector(0,1),Vector(1)), // 1
      Vector(Vector(0,2),Vector(0)), // 2
      Vector(Vector(0,2),Vector(1)), // 3
      Vector(Vector(1,2),Vector(0)), // 4
